...
setIsScrolled(prev=>location.pathname!=="/"?true:prev)
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full flex items-center justify-between px-4 md:px-16 lg:px-24 xl:px-32 transition-all duration-500 z-50 ${
        isScrolled
          ? "bg-white/80 shadow-md text-gray-700 backdrop-blur-lg py-3 md:py-4 opacity-100" 
          : "py-4 md:py-6 opacity-100"
      }`}
    >
      {/* Logo */}
      <Link to="/">
  ...
  alt="logo"
  className="h-10 transition duration-500 opacity-100"
/>
