...
<button className='my-16 px-4 py-2 text-sm font-medium border border-gray-300 rounded bg-white hover:bg-grey-500 transition-all cursor-pointer' onClick={()=>{navigate("/rooms"); scrollTo(0,0)}}>
